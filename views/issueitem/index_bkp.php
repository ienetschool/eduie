		...
		$('.date').datepicker({
          ...
          $('#datatable-responsive').DataTable( {
            ...
            "columnDefs": [
                        ...
                        {
                            "targets": [0,1,2,3,6,7,8,9, 10, 10,11] ,
                            "searchable": false,
                        }
                ],
              search: true,              
...
$('#add_more_btn').hide();
    ...
    function populateItem(school_id) {
        ...
        function addItemGroup()
        {
            ...
            element += '<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"><?php echo $this->lang->line('item'); ?><span class="required">*</span></label>';
            element += '<div class="col-md-6 col-sm-6 col-xs-12">';
            element += '<select  id="item_id'+__item_id_no+'" data-id="'+__item_id_no+'" name="item_id[]" class="form-control item_id select22 col-md-7 col-xs-12"  required="required">';
            ...
            element += '<div class="col-md-6 col-sm-6 col-xs-12">';
            element += ' <div class=""> ';
            element += '  <input  name="mrp[]" placeholder=""  id="price_mrp_'+__item_id_no+'" data-id="'+__item_id_no+'"  value="0" type="text" class="form-control price_input" required="required" />';
            element += '</div>';
            element += '</div>';
            element += '</div>';
            ...
            element += '    <div class="col-md-6 col-sm-6 col-xs-12">';
            element += '        <div class=""> ';
            element += '            <input  name="price[]" placeholder="" id="price_'+__item_id_no+'" data-id="'+__item_id_no+'"  value="0" type="text" class="form-control purchase_input" required="required" readonly/>';
            element += '        </div>';
            element += '    </div>';
            element += '</div>';
