                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>   
                                    ...
                                    $iCount= 1;
										foreach($items as $obj){ 
                                         ...
                                         <td  style="width:20%"><?php echo $obj['item_category']; ?></td>
                                        <td  style="width:30%"><?php echo $obj['item_name']; ?></td>
                                        <td  style="width:10%"><?php echo $school->currency_symbol; ?> <?php echo $obj['mrp']; ?></td>
                                        <td  style="width:10%"><?php echo $school->currency_symbol; ?> <?php 
										...
										$subtotal += $obj->net_amount;
                                            ...
                                            $total = $subtotal+ ($discount*$obj['quantity']);
                                        if ($iDiscount)
                                            $iTotalDiscount =  $iTotalDiscount + ($iDiscount*$obj['quantity']);
                                        $iCount++;
										$index++; } 
									} ?>
                                </tbody>
								<tfoot>
                                    ...
                                    <tr>
										...
										<th style="text-align:right;">(<?php echo numberToCurrency($iTotalDiscount); ?>)</th>
									</tr>
								</tfoot>
                            </table>
                        </div>
