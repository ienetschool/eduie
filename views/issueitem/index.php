                                    ...
                                    <?php $count = 1; if(isset($itemissue) && !empty($itemissue)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php if(has_permission(DELETE, 'inventory', 'issueitem')){ ?>
                                                    <a href="<?php echo site_url('issueitem/revert/'.$obj['invoice_id']); ?>" onclick="javascript: return confirm('Are you sure to revert the sale?');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>Revert </a>
                                                <?php } ?>                                                                          
                                                <?php/* if(has_permission(DELETE, 'inventory', 'issueitem')){ ?>
