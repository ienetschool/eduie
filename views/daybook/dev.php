                                ...
                                <tbody id="data-container"> 
									...
									if(!empty($transactions)){
										...
										<tr>
											...
											<?php $link =  isset($invoice_numbers[$t->invoice_id]) ? '<a href="'.site_url('accounting/invoice/view/'.$t->invoice_id).'" target="_blank">'.$invoice_numbers[$t->invoice_id].'</a>' : (isset($reciept_numbers[$t->donation_id]) ? '<a href="'.site_url('accounting/donation/view/'.$t->donation_id).'" target="_blank" >'.$reciept_numbers[$t->donation_id].'</a>' : (isset($salary_payments[$t->salary_payment_id]) ? '<a href="'.site_url('payroll/payment/payslip/'.$t->salary_payment_id).'" target="_blank" >'.$salary_payments[$t->salary_payment_id].'</a>' : (isset($inventory_invoices[$t->inventory_id]) ? '<a href="'.site_url($inventory_url[$t->inventory_id].'/view/'.$t->inventory_id).'" target="_blank" >'.$inventory_invoices[$t->inventory_id].'</a>' : ""))); ?>
											...
											<td align='right'>
												<?php echo isset($invoice_numbers[$t->invoice_id]) ? '<a href="'.site_url('accounting/invoice/view/'.$t->invoice_id).'" target="_blank">'.$invoice_numbers[$t->invoice_id].'</a>' : (isset($reciept_numbers[$t->donation_id]) ? '<a href="'.site_url('accounting/donation/view/'.$t->donation_id).'" target="_blank" >'.$reciept_numbers[$t->donation_id].'</a>' : (isset($salary_payments[$t->salary_payment_id]) ? '<a href="'.site_url('payroll/payment/payslip/'.$t->salary_payment_id).'" target="_blank" >'.$salary_payments[$t->salary_payment_id].'</a>' : (isset($inventory_invoices[$t->inventory_id]) ? '<a href="'.site_url($inventory_url[$t->inventory_id].'/view/'.$t->inventory_id).'" target="_blank" >'.$inventory_invoices[$t->inventory_id].'</a>' : ""))); ?>
											</td>
