...
<div class="row ">
    ...
    <!-- <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
      <div class="stats-count-inner"> <span class="count_top"> <?php echo isset($school_setting->currency_symbol) ? $school_setting->currency_symbol : '$';  ?> <?php echo $this->lang->line('total'); ?> <?php echo $this->lang->line('income'); ?> </span>
        <div class="count green"><?php echo $total_income ?? '0.00'; ?></div>
      </div>
    </div> -->
    <?php  } ?>
...
<div class="row">
    ...
    <div class="col-md-6 col-sm-12 col-xs-12">
              <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"  style="font-size: 10px;" cellspacing="0" width="49%">
                <tr>
                  <th>Class Name</th>
                  <th>Total Student</th>
                  <th>Present</th>
                ...
                <?php if($studentData){
                    if (count($studentData) >= 2) 
                    {
                        ...
                        // Handle the case where there's only one chunk or no chunks at all
                        $array1 = $studentData;
                        $array2 = []; // Empty array or handle differently as needed
                    }
                    $iTotalStudent = $iTAttendanceCount = 0;
                    foreach ($array1 as $key => $value) {
                        $iAttendenceCount = $studentAttendence[$value->class_id] ?? 0;
                        $iTotalStudent = $iTotalStudent + $value->total_student;
                        $iTAttendanceCount = $iTAttendanceCount + $iAttendenceCount;
                    ?>
                      <tr>
                        <td><?php echo $value->class_name?></td>
                        <td><?php echo ($value->total_student)?></td>
                        <td><?php echo ($iAttendenceCount)?></td>
                      </tr>
                    <?php  } ?>
                    <tr>
                        <td>Total</td>
                        <td><?php echo ($iTotalStudent)?></td>
                        <td><?php echo ($iTAttendanceCount)?></td>
                    </tr>
                <?php }else{ ?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel tile overflow_hidden">
                ...
                <div class="x_content">
                    ...
                    <script type="text/javascript" src='<?php echo VENDOR_URL; ?>fullcalendar/index.global.min.js'></script> 
                    <script type="text/javascript">
                        $(function () {
