				...
				<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">                               
                                <thead> 
								 <tr>
                                        ...
                                        <th style='width:10%;'><?php echo $this->lang->line('transaction_no'); ?></th>
										<th style='width:10%;'><?php echo $this->lang->line('date'); ?></th>
										<th style='width:10%;'><?php echo $this->lang->line('head_ledger'); ?></th>
										<th style='width:10%;'><?php echo $this->lang->line('dr_cr'); ?></th>
										<th style='width:10%;'><?php echo $this->lang->line('total_amount'); ?></th>
										<th style='visible: false;'><?php echo $this->lang->line('total_amount'); ?></th>
                                        <th style='width:5%;', class='no-print'><?php echo $this->lang->line('action'); ?></th>
                                    </tr>
