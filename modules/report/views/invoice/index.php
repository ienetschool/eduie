                    ...
                    <div class="container">
                            <div>
                                <strong>Checked the Checkbox for Hide column</strong>
                                    <input type="checkbox" class="hidecol" value="name" id="col_2" />&nbsp;<?php echo $this->lang->line('academic_year'); ?>&nbsp;
                                    <input type="checkbox" class="hidecol" value="salary" id="col_3" />&nbsp;<?php echo $this->lang->line('group_by_data'); ?>
                                    <input type="checkbox" class="hidecol" value="gender" id="col_4" />&nbsp;<?php echo $this->lang->line('discount'); ?>
                                    <input type="checkbox" class="hidecol" value="city" id="col_5" />&nbsp;<?php echo $this->lang->line('amount'); ?>
                            </div>
                        </div>
                        <!-- ak -->
                                ...
                                <tbody>   
                                    ...
                                    $count = 1; if(isset($invoice) && !empty($invoice)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo  $discount = $obj->total_discount; $discount_total += $discount;?></td>                                            
...
{
    if (confirm('Are you sure to revert the invoice ?'))
    {
        let reason ;
         reason = prompt('Please enter a reason for revert or cancel');
        if (reason)
        {
            location.href='<?php echo site_url('accounting/invoice/revert/'); ?>'+invoice_id+'?reason='+reason;
        }
    }
}
