                       ...
                       <div  class="tab-pane fade in active" id="tab_tabular" >
                           ...
                           <?php if($_POST) {?>
                                    ...
                                    <table id="datatable-keytable" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0"  width="100%">
                                        <thead>
                                            <tr>
                                                <th colspan="<?php echo $sFeeType == "transport" || $sFeeType == "hostel" ? 13 : 14; ?>" style="text-align : center">
                                                    Tution Fee Report |  
                                            ...
                                            <tr>
                                                ...
                                                if ($sFeeType == "transport" || $sFeeType == "hostel"){ ?>
                                                    <th rowspan="3">Total Fees Amount</th>
                                                <?php } 
                                                else
                                                { ?>
                                                ...
                                                <th rowspan="2"  colspan="2">Overdue_amount</th>
                                            </tr>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            foreach($fee_data as $data) { 
                                                ...
                                                {
                                                    // $data['fee_amount'] = 0;;
                                                    $total_annual_fees = $data['fee_amount'];
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($sFeeType != "transport" && $sFeeType != "hostel"){ ?>
...
$(document).ready(function() {
            ...
            $('.datatable-responsive').DataTable({
                ...
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    .column(<?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  5: 6;?> )
                    .data()
                    .reduce( function (a, b) {
                        return intVal(a) + intVal(b);
                    }, 0 );
                    total_amount_re = api
                    .column(<?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  6: 7;?> )
                    .data()
                    .reduce( function (a, b) {
                        return intVal(a) + intVal(b);
                    }, 0 );
                    total_other_discount = api
                    .column(<?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  7: 8;?> )
                    .data()
                    .reduce( function (a, b) {
                        return intVal(a) + intVal(b);
                    }, 0 );
                    total_amount_discount = api
                    .column(<?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  8: 9;?> )
                    .data()
                    .reduce( function (a, b) {
                        return intVal(a) + intVal(b);
                    }, 0 );
                    total_net = api
                    .column(<?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  9: 10;?> )
                    .data()
                    .reduce( function (a, b) {
                        return intVal(a) + intVal(b);
                    }, 0 );
                    ...
                    total_recieved = api
                    .column(<?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  10: 11;?> )
                        .data()
                        .reduce( function (a, b) {
                            return intVal(a) + intVal(b);
                        }, 0 );
                        total_due_student = api
                        .column(<?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  11: 12;?> )
                    .data()
                    .reduce( function (a, b) {
                        return intVal(a) + intVal(b);
                    }, 0 );
                    ...
                    total_due = api
                    .column(<?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  12: 13;?> )
                    .data()
                    .reduce( function (a, b) {
                        return intVal(a) + intVal(b);
                    }, 0 );
                    ...
                    $( api.column( <?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  5: 6;?>  ).footer() ).html(
                        total_student_re 
                    );
                    $( api.column( <?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  6: 7;?>  ).footer() ).html(
                        total_amount_re 
                    );
                    $( api.column( <?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  7: 8;?>  ).footer() ).html(
                        total_other_discount 
                    );
                    $( api.column( <?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  8: 9;?>  ).footer() ).html(
                        total_amount_discount 
                    );
                   

                    $( api.column( <?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  9: 10;?>  ).footer() ).html(
                        total_net 
                    );
                    $( api.column( <?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  10: 11;?>  ).footer() ).html(
                        total_recieved 
                    );
                   
                    $( api.column( <?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  11: 12;?>  ).footer() ).html(
                        total_due_student 
                    );

                    $( api.column( <?php echo $sFeeType == "transport" || $sFeeType == "hostel" ?  12: 13;?>  ).footer() ).html(
                        total_due 
                    );
...
<script type="text/javascript">
   ...
   function get_fee_type_by_year(school_id, academic_year_id, fee_type_id){       
        ...
        $.ajax({       
            ...
            data   : { school_id:school_id, academic_year_id :academic_year_id,fee_type_id : fee_type_id, fee_category : 'fee' },               
            async  : false,
