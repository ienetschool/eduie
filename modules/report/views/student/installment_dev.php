                ...
                <div class="col-md-3 col-sm-3 col-xs-12" >
                    <div class="form-group item">
                        <div>Class <span class="required"> *</span> </div>
                                 ...
                                 <select class="form-control col-md-7 col-xs-12" id="filter_class_id" name="class_id" style="width:auto;" onchange="get_section_by_class(this.value, '');" >
                       ...
                       <div  class="tab-pane fade in active" id="tab_tabular" >
                           <div class="x_content" style="overflow-x:scroll">
                                    ...
                                    <table id="datatable-keytable" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0"  width="100%">
                                        ...
                                        <?php if($_POST) {?>
                                            <tr>
                                                <th colspan="<?php echo 12+count($emi_data)?>" style="text-align : center">
                                        ...
                                        <tbody>
                                            ...
                                            $icount = 0;
                                            $grand_total_due = 0;
                                            foreach($fee_data as $iStudentID => $student) {
                                       ...
                                       <?php if($_POST) {?>
                                            <tr>
                                                <td colspan="<?php echo 2+count($emi_data)?>" >
                                                 Total
                                                </td>
                                                <td >
                                                </td>
