                           ...
                           <table id="datatable-keytable" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                               ...
                               <tbody>   
                                ...
                                foreach($student_data as $key => $obj){ 
                                   ...
                                   {
                                        $previous_year_students_data =  $student_data[$key];
                                        $prev_boys_compare = array_unique($previous_year_students_data['prev']['boys']);
                                        $prev_girls_compare = array_unique($previous_year_students_data['prev']['girls']);
                                        ...
                                        $aPromotedGirls = array_unique(array_intersect($curr_all_girls,$prev_girls_compare));
                                        ...
                                        if ($key == 1482)
                                        {
                                        //   var_dump($aPromotedGirls);  
                                        // echo "<pre>"; 
                                        // print_r(json_encode(array_values($curr_all_girls)));
                                        // echo "<br>"; 
                                        // print_r(count($curr_all_girls));
                                        // echo "<br>"; 
                                        // print_r(json_encode(array_values($prev_girls_compare)));
                                        // echo "<br>"; 
                                        // print_r(count($prev_girls_compare));
                                        // echo "<br>"; 

                                        // print_r(json_encode(array_values($aPromotedGirls)));
                                        // echo "<br>";
                                        //  print_r(count($aPromotedGirls));

                                        // // echo "<br>";
                                        // // print_r( json_encode($prev_girls_compare));
                                        // die(); 
                                   ...
                                   else
                                   {
                                    ...
                                    $current_year_girls_students_data =  $current_year_girls_students[$key];
                                        ...
                                        //    $left_girls = array_diff($prev_girls_compare,$curr_girls);
                                           ...
                                           $aPromotedTotal2 = array_merge($aPromotedTotal2 , $prev_girls_compare);
                                           $aPromotedTotal3 = array_merge($aPromotedTotal3 , $aPromotedGirls);
                                        ...
                                        // echo "<pre>"; var_dump(  $aPromotedTotal); 
                                           ...
                                           $iPromotedGirls = count($aPromotedGirls);
                                           $iPromoted = $iCount == 1 ? 0 : (count($aPromotedBoys) + count($aPromotedGirls));
                                        //    var_dump(count($aPromotedGirls),count($aPromotedGirls));
                                            // var_dump($aPromotedGirls); 
                                   ...
                                   $iPromotedTotal = $iPromotedTotal +  $iPromoted;
                                    ...
                                    ?>
                                       ...
                                       <?php } 
                                    //    sort($aPromotedTotal);
                                    //    sort($aPromotedTotal2);
                                    //    sort($aPromotedTotal3);
                                       
                                       
                                    //                                               echo "<pre>"; 
                                    //                                               print_r(json_encode($aPromotedTotal));
                                    //                                               echo "<br>";
                                    //                                               print_r(count($aPromotedTotal));
                                    //                                               echo "<br>"; 
                                    //                                               print_r(json_encode($aPromotedTotal2));
                                    //                                               echo "<br>";
                                    //                                               print_r(count($aPromotedTotal2));
                                    //                                               echo "<br>"; 
                                    //                                               print_r(json_encode($aPromotedTotal3));
                                    //                                               echo "<br>";
                                    //                                               print_r(count($aPromotedTotal3));
                                    //                                               die(); 
