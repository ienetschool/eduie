                ...
                <div class="col-md-3 col-sm-3 col-xs-12" >
                    <div class="form-group item">
                        <div>Class <span class="required"> *</span> </div>
                                 ...
                                 <select class="form-control col-md-7 col-xs-12" id="filter_class_id" name="class_id" style="width:auto;" onchange="getsections()">
                                ...
                                <select class="form-control col-md-7 col-xs-12" id="filter_section_id" name="section_id" style="width:auto;" >
                                 <option value="">-- Select Section --</option>
                                <?php foreach($sections as $section) { 
                                 ?>

                                     <option value="<?php echo  $section->id  ?>" <?php echo isset($section_id) && $section_id == $section->id ? "selected='selected'" : "" ; ?> ><?php echo  $section->name  ?></option>
                                <?php } ?>   
                                </select>
                        </div>
                </div>
               ...
               <div class="" data-example-id="togglable-tabs">
                   ...
                   <div class="tab-content">
                       <div  class="tab-pane fade in active" id="tab_tabular" >
                                    ...
                                    <table id="datatable-keytable" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0"  width="100%">
                                        ...
                                        <?php if($_POST) {?>
                                            ...
                                            <tr>
                                                ...
                                                <th  <?php echo $rowspan  ?>>Fee amount</th>
						...
						<th <?php echo $rowspan ?>>Previous Year Due Amount</th>     
                                        ...
                                        <tbody>
                                            ...
                                            <td ><?php echo $icount; ?></td>
                                                ...
                                                <?php } ?>
						 <td ><?php $lastyear= $student->due_amount?$student->due_amount:0; echo $lastyear; ?></td>    
                                                <td ><?php 
                                               
                                                 $total_due =$fee_amount-($total_paid+$total_discount) + $lastyear;
...
function getsections() {
    var filter_class_id = $("#filter_class_id").val();
     $.ajax({       
           type   : "POST",
           url    : "<?php echo site_url('report/getSectionOfClass'); ?>",
           data   : {class_id:filter_class_id},               
           async  : false,
