                ...
                <div class="row"> 
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control col-md-7 col-xs-12" name="month" id="month" >
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 layout-box">
                                                <div>
                                                    ...
                                                    <h3 class="head-title ptint-title" style="width: 100%;"><i class="fa fa-bar-chart"></i><small><?php echo $this->lang->line('teacher'); ?> <?php echo $this->lang->line('attendance'); ?> <?php echo $this->lang->line('report'); ?></small></h3>                
                                                    <div class="clearfix">&nbsp;</div>
                                                </div>
                                            </div>
                                                <div class="col-sm-3  col-xs-3"></div>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_tabular" >
                            ...
                            <table class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <td><?php echo $this->lang->line('teacher'); ?> <i class="fa fa-long-arrow-down" z></i> - <?php echo $this->lang->line('date'); ?> <i class="fa fa-long-arrow-right"></i></td>
                                        <?php
                                        $aTotalPresent = array();
                                        $aTotalAbsent = array();
                                        for($i = 1; $i<=$days; $i++ ){
                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($teachers) && !empty($teachers)){ ?>
                                        <?php foreach($teachers as $obj){ 
                                            $iStudentPresent = $iStudentAbsent = 0;

                                            ?>
                                        <tr>
                                            <td><?php echo $obj->name; ?></td>
                                            <?php $attendance = get_teacher_monthly_attendance($school_id, $obj->id, $academic_year_id, $month_number ,$days); ?>
                                            <?php if(!empty($attendance)){ ?>
                                                <?php foreach($attendance AS $key => $sValue){
                                                    ...
                                                    ?>
                                                    <td> <?php echo $sValue ? "$sValue" : '<i style="color:red;">--</i>'; ?></td>
                                                <?php } ?>
                                                <td> <?php echo "A:$iStudentAbsent P:$iStudentPresent"; ?></td>
