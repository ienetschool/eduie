                   ...
                   <div class="col-md-12 col-sm-12">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-2 invoice-col text-left custom_col_20">
                                ...
                                <b><?php echo $this->lang->line('invoice'); ?> #<?php echo $invoice->custom_invoice_id;  ?></b>&nbsp;&nbsp;<b>
                                <br>
                                ...
                                <br><b><?php echo $this->lang->line('transaction_id'); ?> :</b> <?php echo $invoice->transaction_no;  ?>        
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>   
                                    ...
                                    $income_head_id = 0;
										foreach($invoice->detail as $obj){ 
                                            if($obj->emi_type)
                                            {
                                                ...
                                                $emi_due = $emi_amount-$obj->net_amount ;
                                            }
                                            else
                                            {
                                                $emi_amount = 0;
                                        ...
                                        <td style="text-align:right;"><?php echo $school->currency_symbol; ?><?php echo $obj->net_amount; ?></td>
                                    </tr> 
										<?php 
                                    ...
                                    <tr>
                                        ...
                                        <td  style="width:10%"> <?php echo $school->currency_symbol; ?><?php echo $emi_amount  ?></td>
                                        <td  style="width:10%"><?php echo $school->currency_symbol; ?> <?php echo $emi_due; ?></td>
                                        <td style="text-align:right;"><?php echo $school->currency_symbol; ?><?php echo $invoice->paid_status == "paid" || $invoice->paid_status == "partial" ? $invoice->net_amount : $invoice->gross_amount; ?></td>
                                    </tr> 
									<?php } ?>
                                </tbody>
								<tfoot>
									...
									<tr>
										...
										<th style="text-align:right;"><?php echo numberToCurrency($discount); ?></th>
									</tr>
                                    <?php if($invoice->previous_due_amount) {?>
                                        <tr>
										<th colspan=<?php echo  $colspan; ?>>Previous Due</th>
										<th style="text-align:right;"><?php echo numberToCurrency($invoice->previous_due_amount); ?></th>
									</tr>
                                     <?php }?>
									<tr>
										<th colspan=<?php echo  $colspan; ?>>Total</th>
										<th style="text-align:right;"><?php echo numberToCurrency($total); ?></th>
									</tr>
								</tfoot>
                            </table>
                        </div>
              ...
              <div class="x_content">
                ...
                <section class="content invoice">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->  <b><br>&nbsp;Signature of Cashier ________________ </b>
                    </div>
                    <!-- /.row -->
                    <footer>
                        <span class="footer_text_custom">
                    Generated by : <?php echo $this->session->userdata('username'); ?>  Date  :  <?php echo  date('Y-m-d'); ?></span>
                    </footer>
