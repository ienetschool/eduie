...
class Report extends My_Controller {
    ...
    * ********************************************************** */
    public function expenditure() {
        ...
        //         WHERE E.status = 1 ";
        //          // $this->data['expenditure'] = $this->db->query($sql)->result();
        //           $data1 = $this->db->query($sql)->result();
                  
        //     if($data>1){
        //     	// print_r(count($data1));exit;
    ...
    * ********************************************************** */
    public function invoice() {
        ...
        // 	 $sql = "SELECT I.*, SUM(I.net_amount) AS total_amount, SUM(I.discount) AS total_discount, H.title AS head
        //         FROM invoices AS I               
        ...
        //         // $this->data['invoice'] = $this->db->query($sql)->result();
        //          $data1 = $this->db->query($sql)->result();
