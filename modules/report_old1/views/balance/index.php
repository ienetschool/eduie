                 ...
                 <div class="container">
                            <div>
                                <strong>Checked the Checkbox for Hide column</strong>
                                    <input type="checkbox" class="hidecol"  id="col_2" />&nbsp;<?php echo $this->lang->line('group_by_data'); ?>&nbsp;
                                    <input type="checkbox" class="hidecol"  id="col_3" />&nbsp;<?php echo $this->lang->line('income'); ?>
                                    <input type="checkbox" class="hidecol"  id="col_4" />&nbsp;<?php echo $this->lang->line('expenditure'); ?>
                                    <input type="checkbox" class="hidecol"  id="col_5" />&nbsp;<?php echo $this->lang->line('balance'); ?>
                            </div>
                        </div>
<!-- ak -->
                <?php echo form_close(); ?>
