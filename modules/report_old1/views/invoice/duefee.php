                 ...
                 <div class="container">
                            <div>
                                <strong>Checked the Checkbox for Hide column</strong>
                                    ...
                                    <input type="checkbox" class="hidecol" value="salary" id="col_3" />&nbsp;<?php echo $this->lang->line('student'); ?>
                                    <input type="checkbox" class="hidecol" value="gender" id="col_4" />&nbsp;<?php echo $this->lang->line('class'); ?>
                                    <input type="checkbox" class="hidecol" value="city" id="col_5" />&nbsp;<?php echo $this->lang->line('title'); ?>
                                    <input type="checkbox" class="hidecol" value="email" id="col_6" />&nbsp;<?php echo $this->lang->line('payment'); ?> <?php echo $this->lang->line('method'); ?>
                            </div>
                        </div>
