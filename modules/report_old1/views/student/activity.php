                 ...
                 <div class="container">
                            <div>
                                <strong>Checked the Checkbox for Hide column</strong>
                                    ...
                                    <input type="checkbox" class="hidecol"  id="col_5" />&nbsp;<?php echo $this->lang->line('section'); ?>
                                    <input type="checkbox" class="hidecol" id="col_6" />&nbsp;<?php echo $this->lang->line('activity'); ?>
                                    <input type="checkbox" class="hidecol" id="col_7" />&nbsp;<?php echo $this->lang->line('activity'); ?> <?php echo $this->lang->line('date'); ?>
                            </div>
                        </div>
                <!-- ak -->
