                        ...
                        <?php if($this->session->userdata('role_id') == SUPER_ADMIN || $this->session->userdata('dadmin') == 1){  ?>                                 
                             <select  class="form-control col-md-7 col-xs-12" onchange="get_invoice_by_class(this.value);">
                                 ...
                                 <?php foreach ($classes as $key => $value){ ?>
                                     <option value="<?php echo site_url('accounting/invoice/class_by/'.$akash."/".$value['id']); ?>" <?php if(isset($filter_class_id) && $filter_class_id == ($value['name'])){ echo 'selected="selected"';} ?> > <?php echo ($value['name']); ?></option>
                                 <?php } ?>   
                             </select>
                         <?php } ?>  
                        </li>     
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_invoice_list" >
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($invoices) && !empty($invoices)){ $b = 0; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if($obj->due_amount == 0){
                                                echo "Paid";
                                            }else{ 
                                                echo $obj->due_amount;} ?></td>
