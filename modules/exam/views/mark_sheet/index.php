    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                ?>
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" style="margin-bottom:0px;<?php echo $sDisplay; ?>" cellspacing="0" >
                   <thead>
                    <tr>
                            <th colspan="100%">
                                    ...
                                    <div class="float-child" style="width:60%!important;text-align:left;margin-top: 5px;margin-left: 20px;">
                                        ...
                                        <div class="float-child admit-card-logo" >
                                                        <?php  if($student->photo != ''){ ?>
                                                        <img src="<?php echo UPLOAD_PATH; ?>/student-photo/<?php echo $student->photo; ?>" alt="" /> 
                                                        <?php }else{ ?>
                        ...
                        <tr>
                            ...
                            <?php foreach($exams_n as  $exam_id_n => $exam){ 
                                $iVivaMark = $check_exams[$exam_id_n]['viva_exist'] ?? 0;
                                $iTHeoryMark = $check_exams[$exam_id_n]['theory_exist'] ?? 0;
                                $iPractivalMark = $check_exams[$exam_id_n]['practical_exist'] ?? 0;
                                if (!$iVivaMark && !$iTHeoryMark && !$iPractivalMark)
                                    continue;
                                $iColSpan = 2;
                                ...
                                ?>
                                <th colspan="<?php echo $iColSpan; ?>"  style="text-align:center"><?php echo $exam ?></th>
                            <?php } ?>    
                ...
                <div class="float-container" style="background : unset !important; <?php echo $sDisplay; ?>">
                    ...
                    if( $iPrevMark!=$percentage)
                    {
                        $iRank++;
                    }
                    $iPrevMark = $percentage;
                    ?>
                    <b>Percentage : <?php echo $percentage  ?> %</b><br>
                    <?php
                    
                    $grade = find_grade($grades,(float)$percentage);
                ...
                <div class=" row <?php echo !$selected_student_id ? 'footer-div' : '';?> " style="<?php echo $sDisplay; ?>">
