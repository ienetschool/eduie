...
class Member_Model extends MY_Model {
    ...
    function __construct() {
     ...
     public function get_hostel_member_list($is_hostel_member = 1, $school_id = null, $academic_year_id = null ,$limit =null,$start=null,$search_text= null) {
        ...
        if( $is_hostel_member) {
            $this->db->where("exists( select id from hostel_members HM where HM.user_id = ST.user_id and (HM.academic_year_id=$academic_year_id or coalesce(HM.academic_year_id,0)=0) )");
        }
        else {
        ...
        $this->db->or_where('E.academic_year_id in (select previous_academic_year_id from enrollments where student_id=ST.id and school_id=ST.school_id)');
        $this->db->group_end();
    ...
    public function get_hostel_non_member_list($is_hostel_member = 1, $school_id = null, $academic_year_id = null ,$limit =null,$start=null,$search_text= null) {
        ...
        $this->db->where("not exists( select id from hostel_members HM where HM.user_id = ST.user_id and (HM.academic_year_id=$academic_year_id ) )");
    ...
    public function get_hostel_non_member_list_total_1($school_id = null, $academic_year_id = null,$search_text=null ) {
    ...
    public function get_hostel_non_member_list_total($is_hostel_member = 1, $school_id = null, $academic_year_id = null,$search_text=null ) {
