...
exit;
    ...
    * ********************************************************** */
    ...
    // if($school_id){
        $school = $this->member->get_school_by_id($school_id);
        $is_hostel_member = 0;
        $totalRecords = $this->member->get_hostel_non_member_list_total($is_hostel_member, $school_id, @$school->academic_year_id,$search_text);
        $members = $this->member->get_hostel_non_member_list($is_hostel_member, $school_id, @$school->academic_year_id,$limit,$start,$search_text);
       }
       else
       {
         $members = array();
