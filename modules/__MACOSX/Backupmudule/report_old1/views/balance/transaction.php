                 ...
                 <div class="container">
                            <div>
                                <strong>Checked the Checkbox for Hide column</strong>
                                    ...
                                    <input type="checkbox" class="hidecol"  id="col_3" />&nbsp;<?php echo $this->lang->line('transaction'); ?> <?php echo $this->lang->line('title'); ?>
                                    <input type="checkbox" class="hidecol"  id="col_4" />&nbsp;<?php echo $this->lang->line('payment'); ?> <?php echo $this->lang->line('method'); ?>
                                    <input type="checkbox" class="hidecol"  id="col_5" />&nbsp;<?php echo $this->lang->line('payment'); ?> <?php echo $this->lang->line('date'); ?>
                                    <input type="checkbox" class="hidecol"  id="col_6" />&nbsp;<?php echo $this->lang->line('amount'); ?>
