                 ...
                 <div class="container">
                            <div>
                                <strong>Checked the Checkbox for Hide column</strong>
                                    ...
                                    <input type="checkbox" class="hidecol" value="gender" id="col_4" />&nbsp;<?php echo $this->lang->line('issue'); ?> <?php echo $this->lang->line('total'); ?>
                                    <input type="checkbox" class="hidecol" value="city" id="col_5" />&nbsp;<?php echo $this->lang->line('return'); ?> <?php echo $this->lang->line('total'); ?> 
                                    <input type="checkbox" class="hidecol" value="city" id="col_5" />&nbsp;<?php echo $this->lang->line('remain'); ?> <?php echo $this->lang->line('total'); ?>
                            </div>
                        </div>
                <?php echo form_close(); ?>
            </div>
