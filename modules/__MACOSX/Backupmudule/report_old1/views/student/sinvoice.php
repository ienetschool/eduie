                 ...
                 <div class="container">
                            <div>
                                <strong>Checked the Checkbox for Hide column</strong>
                                    ...
                                    <input type="checkbox" class="hidecol" id="col_6" />&nbsp;<?php echo $this->lang->line('net_amount'); ?>
                                    <input type="checkbox" class="hidecol" id="col_7" />&nbsp;<?php echo $this->lang->line('paid'); ?> <?php echo $this->lang->line('amount'); ?>
                                    <input type="checkbox" class="hidecol"  id="col_8" />&nbsp;<?php echo $this->lang->line('balance'); ?>
                            </div>
                        </div>
                <!-- ak -->
