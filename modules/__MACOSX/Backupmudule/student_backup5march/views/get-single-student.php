            ...
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $this->lang->line($student->alternate_name); ?></td>
                    ...
                    <tr>
                        ...
                        <td><?php echo $this->lang->line($student->reservation_category); ?></td>
                        <th><?php echo $this->lang->line('bpl'); ?></th>
                        <td><?php echo $student->bpl; ?></td>
                    </tr>
                    <tr>
                        <th><?php echo $this->lang->line('adhar_no'); ?></th>
                        <td><?php echo $this->lang->line($student->adhar_no); ?></td>
                        <th><?php echo $this->lang->line('sm_id'); ?></th>
                        <td><?php echo $student->sm_id; ?></td>
                    </tr>
                    <tr>
                        <th><?php echo $this->lang->line('family_id'); ?></th>
                        <td><?php echo $this->lang->line($student->family_id); ?></td>
                        <th><?php echo $this->lang->line('bank_details'); ?></th>
                        <td><?php echo $student->bank_details; ?></td>
                    </tr>
                    <tr>
                        <th><?php echo $this->lang->line('reason_of_seperation'); ?></th>
                        <td><?php echo $this->lang->line($student->reason_of_seperation); ?></td>
                        <th><?php echo $this->lang->line('date_of_seperation'); ?></th>
                        <td><?php echo date('Y-m-d',strtotime($student->date_of_seperation)); ?></td>
                    </tr>
                    <tr>
