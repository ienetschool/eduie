                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <input  class="form-control col-md-7 col-xs-12"  name="rte"  id="rte" value="<?php echo isset($post['rte']) ?  $post['rte'] : ''; ?>" placeholder="<?php echo $this->lang->line('rte'); ?>" type="text" autocomplete="off">
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <input  class="form-control col-md-7 col-xs-12"  name="rte"  id="rte" value="<?php echo isset($student->rte) ?  $student->rte : ''; ?>" placeholder="<?php echo $this->lang->line('rte'); ?>" type="text" autocomplete="off">
                                             <div class="help-block"><?php echo form_error('rte'); ?></div>
                                         </div>
                                     </div>                                          
                                </div>
