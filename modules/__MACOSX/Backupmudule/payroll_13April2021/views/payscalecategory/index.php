...
<div class="item form-group otherPayScaleCategory" style="display:none;">
                              ...
                              <div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">  
                                            <input  class=""  name="is_deduction_type" id="add_deduction_type" value="TRUE" <?php echo (isset($post['is_deduction_type']) && $post['is_deduction_type']=='TRUE') ?  "checked='checked'" : ''; ?>" type="checkbox">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('payroll/payscalecategory/edit/'.$grade->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <?php $this->load->view('layout/school_list_edit_form'); ?> 
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">                                                 
                                        <select  class="form-control col-md-7 col-xs-12" name="debit_ledger_id" id="edit_debit_ledger_id">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">                                    
                                        <select  class="form-control col-md-7 col-xs-12" name="credit_ledger_id" id="edit_credit_ledger_id">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
...
<div class="item form-group otherPayScaleCategory" style="display:none;">
                              ...
                              <div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">  
                                            <input  class=""  name="is_deduction_type" id="edit_deduction_type" value="TRUE" <?php echo (isset($grade->is_deduction_type) && $grade->is_deduction_type=='TRUE') ?  "checked='checked'" : ''; ?>" type="checkbox">
                                            <div class="help-block"><?php echo form_error('is_deduction_type'); ?></div>
                                        </div>
                                    </div>		
                                <div class="item form-group">
    ...
    $("document").ready(function() {		
		 ...
		 if($("#edit_school_id").length == 0) {			 
			 ...
			 $("#edit_school_id").trigger('change');	
				...
				unboundPayScale("edit_unbound_payscale_category");
         <?php } ?>		 
