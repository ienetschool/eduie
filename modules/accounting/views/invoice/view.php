                   ...
                   <div class="col-md-12 col-sm-12">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-md-2 col-sm-2 col-xs-2 invoice-col text-left custom_col_20">
                                ...
                                <br>
                                <b><?php echo $this->lang->line('payment'); ?> <?php echo $this->lang->line('status'); ?>:</b> <span class="btn-success"><?php echo !$invoice->reverted ? get_paid_status($invoice->paid_status) : "Reverted"; ?></span>
