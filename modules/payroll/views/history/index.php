                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control col-md-7 col-xs-12"  name="payment_to"  id="payment_to" onchange="get_user_list(this.value);" required="required">
                                ...
                                <option value="all" <?php if(isset($payment_to) && $payment_to == 'all'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('all'); ?></option>
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($payments) && !empty($payments)){ ?>
                                        ...
                                        ?>
                                        <tr class="<?php echo $obj->reverted ==1 ? 'strikeRow' : '' ; ?>">
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(VIEW, 'payroll', 'payment') && $obj->payment_status == 'paid' && $obj->reverted !=1 ){ ?>
                                                <a href="<?php echo site_url('payroll/payment/payslip/'.$obj->id); ?>"
                                                    class="btn btn-success btn-xs"><i class="fa fa-eye"></i>
                                                    <?php echo $this->lang->line('payslip'); ?> </a>
                                                <?php } ?>
                                                <!-- <?php if(has_permission(DELETE, 'payroll', 'history')){ ?>
                                                    <a href="<?php echo site_url('payroll/payment/delete_payslip/'.$obj->id); ?>" class="btn btn-danger btn-xs" ><i class="fa fa-eye"></i> Delete </a>
                                                <?php } ?> -->
                                                <?php 
                                                if ( check_is_previous_year($obj->school_id) != 1) {
                                                if(has_permission(DELETE, 'payroll', 'history') && $obj->reverted !=1 ){ ?>
                                                    <a href="<?php echo site_url('payroll/payment/revert/'.$obj->id); ?>" class="btn btn-danger btn-xs" ><i class="fa fa-eye"></i> Revert </a>
                                                <?php } 
                                                }
                                                ?>
                                            </td>
