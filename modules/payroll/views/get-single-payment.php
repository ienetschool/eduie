<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
    <tbody>
        ...
        <tr>
			...
			<td <?php print ($payment->payment_status == 'unpaid' || !$payment->reverted)? "style='color:red;font-weight:bold;'" : ''; ?>><?php print  !$payment->reverted ? $payment->payment_status : "Reverted"; ?></td>
        </tr>
