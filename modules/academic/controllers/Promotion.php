    ...
    public function index() {                
        ...
        if($this->session->userdata('role_id') != SUPER_ADMIN){ 
           ...
           // $this->data['classes'] = $this->promotion->get_list('classes', $condition, '','', '', 'id', 'ASC');
            ...
            $this->data['school_id'] = $condition['school_id'];
            ...
            if(!empty($_POST['students'])){
                ...
                foreach($_POST['students'] as $key=>$value){
                       ...
                       if(empty($exist)){ 
                            ...
                            $data['previous_academic_year_id'] = $current_session_id; 
                            $data['previous_class_id'] = $current_class_id; 
//                             $this->__invoice_creation($data);         
// die();
                            $insert_id = $this->promotion->insert('enrollments', $data);
