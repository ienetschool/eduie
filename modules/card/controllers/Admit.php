    ...
    public function index(){
        ...
        $this->data['students'] = '';
         ...
         if ($_POST) {
            ...
            $this->data['subjects'] = $this->schedule->get_schedule_list($class_id, $school_id, $this->data['school']->academic_year_id, $exam_id, "ES.optional asc");
        ...
        if($this->session->userdata('role_id') != SUPER_ADMIN && $this->session->userdata('dadmin') != 1){            
            ...
            $condition['status'] = 1;        
            $this->data['classes'] = $this->student->get_list_new('classes', $condition, '','', '', 'id', 'ASC');
