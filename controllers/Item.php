...
{	
    public function __construct()
    {
     ...
     public function index($school_id = null) {
        ...
        $this->data['items'] = $this->item->get_item_list_dev($school_id, $category_id, $group_id, $financial_start_date, $financial_end_date );

        $this->data['start_date'] = $financial_start_date;     
        $this->data['end_date'] = $financial_end_date;     
        ...
        $this->layout->view('item/index_new', $this->data);            
    }
    ...
    * ********************************************************** */ 
	...
	function getAvailQuantity() {
        ...
        if($available>=0){
             echo json_encode(array('available' => $available,'last_price'=>$last_price,'last_mrp'=>$last_mrp, 'query'=>$sQuery));
        }else{
             echo json_encode(array('available' => 0,'last_price'=>$last_price,'last_mrp'=>$last_mrp, 'query'=>$sQuery));
        }
