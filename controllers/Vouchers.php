                    ...
                    $row_data = array();
					 ...
					 if($this->session->userdata('role_id') == SUPER_ADMIN || $this->session->userdata('dadmin') == 1){ 
                        ...
                        if(has_permission(ADD, 'accounting', 'accounttransactions')){
                            ...
                            else if ($obj->is_readonly == 0 && $is_previous_year == true && $iForceAllow == 2  ){ 
                            ...
                            else if($obj->is_readonly == 0 &&  (!$is_previous_year ||  ($is_previous_year == true && $obj->type_id == 1) || $iForceAllow  == 1)){ 
                                // check if financial year
                                $currentDate = date('Y-m-d');
