...
$config['base_url'] =  'https://schools.ienet.online';

// example
// $config['base_url'] =  'http://school.vivaindia.com';
...
define('SMS', 'IeNet');
define('FROM_EMAIL', 'info@ienet.com');
define('FROM_NAME', 'IENet');
